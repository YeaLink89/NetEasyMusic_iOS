...
- (UIScrollView *)topTabScrollView{
    if (!_topTabScrollView){
        ...
        _lineBottom = [[UIView alloc] initWithFrame:CGRectMake(0, TAB_HEIGHT - LINEBOTTOM_HEIGHT,[_titleSizeArray[0] CGSizeValue].width+10, LINEBOTTOM_HEIGHT)];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    _lineBottom.bounds = CGRectMake(0, 0, [self getTitlePoint:scrollView.contentOffset.x] + 10, LINEBOTTOM_HEIGHT);
